        ...
        <div class="w-full">
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center">
              ...
              <div class="hidden xl:flex"><a href="<?php echo get_page_url('page-contacts'); ?>" class="bg-red-400 hover:bg-red-500 text-white font-medium rounded-lg px-6 py-2"><?php _e("Контакты", "treba-wp"); ?></a></div>
